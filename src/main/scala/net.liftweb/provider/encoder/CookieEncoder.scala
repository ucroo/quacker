...
/** Converts an HTTPCookie into a string to used as header cookie value.
  *
  * The string representation follows the <a href="https://tools.ietf.org/html/rfc6265">RFC6265</a> standard with the
  * added field of SameSite to support secure browsers as explained at <a
  * href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Set-Cookie/SameSite">MDN SameSite Cookies</a>
  *
...
object CookieEncoder {
  ...
  private val CALENDAR_MONTH_TO_SHORT_NAME =
